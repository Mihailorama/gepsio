...
{
    /// <summary>
    /// This class executes the XBRL-CONF-CR5-2012-01-24 conformance test suite.
    /// </summary>
    /// <remarks>
    ...
    public class XBRLCONFCR520120124Test
    {
        ...
        public void ExecuteXBRLCONFCR520120124Testcases()
        {
            thisTestsPassed = 0;
            var conformanceXmlSource = ConfigurationManager.AppSettings["ConformanceXmlCR5"];
